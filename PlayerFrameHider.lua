...
PFH.DEFAULTS = {
  ...
  hideBagsBar = true,
  hideMicroMenu = true,
  showActionBar1WhenSkyriding = true,
  hideBuffFrame = true,
  ...
  controlEssentialCooldowns = true,
  controlUtilityCooldowns = true,
  controlTrackedBuffs = true,
  cooldownDisplayMode = 3,
  ...
  hideDamageMeter = true,
  showDamageMeterInCombat = true,
  fadeDuration = 1,
}
